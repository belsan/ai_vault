% =============================================================
% Chapter (later in the book) --- Building Reliable Systems
% =============================================================
%
% Intended position: at the end of the agents arc, after the
% chapters on agent design, orchestration, and context engineering.
% Filed at 06 for now because there are no agent chapters yet to
% sit between Tool Calls and this one. Renumber when they land.
...
task is done. Mitigation: summarisation passes, sliding-window
