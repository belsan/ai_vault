...
saved: 2026-06-01
note: |
  Synthesis post pulling together the "harness engineering" thread:
  Trivedy's Agent = Model + Harness equation, HumanLayer's "skill
  issue" reframing, Anthropic's long-running-app guidance, and
  Birgitta Böckeler's UX work. Useful as the canonical definition
  of "harness" for the manuscript's agents chapter.
---
